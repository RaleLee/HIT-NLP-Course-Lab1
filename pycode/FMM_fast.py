# coding=utf-8
from utils import readFile, writeList, binary_search
from HashSet import HashSet, HashSetL, HashSetZ
import time, datetime

def FMMwithBi(dicpath, textpath):
    # read text from file
    ...
    return "Bi-search: " + str((endTime - startTime))+ "s"

def FMMwithHashSetL(dicpath, textpath):
    # read text from file
    textlines = readFile(textpath)
    ...
    endTime = time.time()
    print((endTime - startTime))
    return "HashSetL: " + str((endTime - startTime))  + "s"

def FMMwithSet(dicpath, textpath):
    # read text from file
    textlines = readFile(textpath)
    ...
    endTime = time.time()
    print((endTime - startTime))
    return "Python Set: " + str((endTime - startTime)) + "s"

dicpath = "outputs/dic.txt"
textpath = "dataset/199801_sent.txt"
timepath = "outputs/TimeCost.txt"
def main():
    TimeList = []
    TimeList.append(FMMwithBi(dicpath, textpath))
    TimeList.append(FMMwithHashSetL(dicpath, textpath))
    TimeList.append(FMMwithSet(dicpath, textpath))
    writeList(timepath, TimeList)
    return
